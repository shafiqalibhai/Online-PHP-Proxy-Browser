initializeWindows = function(){
	...
	MochaUI.proxyWindow = function(){
		new MochaUI.Window({
			id: 'proxy',
			title: 'UT - Proxy Browser - USA',
			loadMethod: 'iframe',
			contentURL: 'proxy/index.php?proxyserver=207.218.241.2&proxyport=3128',
			width: 500,
			height: 400,
			resizeLimit:  {'x': [330, 2500], 'y': [250, 2000]},
			contentBgColor: '#fff'			
		...
		$('usa').addEvent('click', function(e){
		new Event(e).stop();
			MochaUI.proxyWindow();
		});	
		
		MochaUI.proxyWindow1 = function(){
		new MochaUI.Window({
			id: 'proxy1',
			title: 'UT - Proxy Browser - China',
			loadMethod: 'iframe',
			contentURL: 'proxy/index.php?proxyserver=210.82.113.9&proxyport=3128',
			width: 500,
			height: 400,
			resizeLimit:  {'x': [330, 2500], 'y': [250, 2000]},
			contentBgColor: '#fff'			
		...
		$('china').addEvent('click', function(e){
		new Event(e).stop();
			MochaUI.proxyWindow1();
		});
		
		MochaUI.proxyWindow2 = function(){
		new MochaUI.Window({
			id: 'proxy2',
			title: 'UT - Proxy Browser - European Union',
			loadMethod: 'iframe',
			contentURL: 'proxy/index.php?proxyserver=210.82.113.9&proxyport=3127',
			width: 500,
			height: 400,
			resizeLimit:  {'x': [330, 2500], 'y': [250, 2000]},
			contentBgColor: '#fff'			
		...
		$('eu').addEvent('click', function(e){
		new Event(e).stop();
			MochaUI.proxyWindow2();
		});
		
		MochaUI.proxyWindow3 = function(){
		new MochaUI.Window({
			id: 'proxy3',
			title: 'UT - Proxy Browser - UAE',
			loadMethod: 'iframe',
			contentURL: 'proxy/index.php?proxyserver=195.229.177.28&proxyport=80',
			width: 500,
			height: 400,
			resizeLimit:  {'x': [330, 2500], 'y': [250, 2000]},
			contentBgColor: '#fff'			
		...
		$('uae').addEvent('click', function(e){
		new Event(e).stop();
			MochaUI.proxyWindow3();
		});
